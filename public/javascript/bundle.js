...
},{"process":"../../node_modules/process/browser.js"}],"alert.js":[function(require,module,exports) {
"use strict";
...
},{"./alert":"alert.js","axios":"../../node_modules/axios/index.js"}],"login.js":[function(require,module,exports) {
"use strict";
...
var login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(logUsername, logPassword) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.errorMessage) {
              document.querySelector(".errorMessage").innerHTML = "".concat(res.data.errorMessage);
            }
...
exports.login = login;
},{"axios":"../../node_modules/axios/index.js"}],"untils/timestamp.js":[function(require,module,exports) {
"use strict";
...
exports.getPostData = exports.retweetPostToggle = exports.getPostIdFromElement = exports.likePostToggle = exports.outputPosts = exports.getPosts = exports.createPostHtml = exports.createPost = void 0;

var _axios = _interopRequireDefault(require("axios"));

var _timestamp = require("./untils/timestamp");
...
var createPostHtml = function createPostHtml(postData) {
  ...
  if (postData.postedBy._id === userLoggedIn._id) {
    buttons = "<button data-id=\"".concat(postData._id, "\" data-toggle=\"modal\" data-target=\"#deletePostModal\"> \n                        <i class=\"fas fa-times\"></i>\n                    </button>");
  }
...
var outputPosts = function outputPosts(results, container) {
  console.log(results);
  container.html("");
  results.forEach(function (postData) {
...
exports.outputPosts = outputPosts;

var likePostToggle = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PUT',
              url: "http://127.0.0.1:3004/api/posts/".concat(postId, "/likes")
            });
  ...
  return function likePostToggle(_x2) {
    return _ref3.apply(this, arguments);
  };
}();

exports.likePostToggle = likePostToggle;

var getPostIdFromElement = function getPostIdFromElement(element) {
...
exports.getPostIdFromElement = getPostIdFromElement;

var retweetPostToggle = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PUT',
              url: "http://127.0.0.1:3004/api/posts/".concat(postId, "/retweets")
            });
...
exports.retweetPostToggle = retweetPostToggle;

var getPostData = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(postId) {
    var res;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "GET",
              url: "http://127.0.0.1:3004/api/posts/".concat(postId)
            });
  ...
  return function getPostData(_x4) {
    return _ref5.apply(this, arguments);
  };
}();

exports.getPostData = getPostData;
},{"axios":"../../node_modules/axios/index.js","./untils/timestamp":"untils/timestamp.js"}],"postPage.js":[function(require,module,exports) {
"use strict";
...
var _require = require("./post"),
    outputPosts = _require.outputPosts;

var _require2 = require("./post"),
    getPostData = _require2.getPostData;

function outputPostWithReplies(data, container) {
  container.html("");

  if (data.replyTo) {
    var html = (0, _post.createPostHtml)(data.replyTo);
    container.append(html);
  }

  data.replies.forEach(function (postData) {
    var html = (0, _post.createPostHtml)(postData);
    container.append(html);
  });
}
...
},{"./post":"post.js"}],"home.js":[function(require,module,exports) {
...
$(document).ready( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8() {
  var registerForm, loginForm, postTextarea, submitButton, postsContainer, res;
    ...
    while (1) {
      switch (_context8.prev = _context8.next) {
        case 0:
          ...
          submitButton = document.getElementById("submitPostButton");
                  ...
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        ...
                        _context.next = 10;
                        return (0, _Register.submit)(formData);
          ...
          if (loginForm) {
            loginForm.addEventListener("submit", function (evt) {
              evt.preventDefault();
              var logUserName = loginForm.querySelector(".log-user").value;
              var logPassword = loginForm.querySelector(".log-password").value;
              (0, _login.login)(logUserName, logPassword);
            });
          }

          if (postTextarea) {
            postTextarea.addEventListener("keyup", function (evt) {
              {
                var textBox = evt.target.value.trim();
                  ...
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      case 0:
                        ...
                        _context2.next = 5;
                        return (0, _post.createPost)(data);

                      case 5:
                        postData = _context2.sent;

                        if (postData.status === "success") {
                          html = (0, _post.createPostHtml)(postData.post);
        ...
        case 14:
              ...
              return regeneratorRuntime.wrap(function _callee3$(_context3) {
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    case 0:
                      button = $(evt.target);
                      postId = (0, _post.getPostIdFromElement)(button);
                      _context3.next = 4;
                      return (0, _post.likePostToggle)(postId);
                ...
                while (1) {
                  switch (_context4.prev = _context4.next) {
                    case 0:
                      ...
                      postId = (0, _post.getPostIdFromElement)(button);
                      _context4.next = 4;
                      return (0, _post.retweetPostToggle)(postId);
          ...
          $("#replyModal").on("show.bs.modal", /*#__PURE__*/function () {
            var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(evt) {
              ...
              return regeneratorRuntime.wrap(function _callee5$(_context5) {
                while (1) {
                  switch (_context5.prev = _context5.next) {
                    case 0:
                      button = $(evt.relatedTarget);
                      postId = (0, _post.getPostIdFromElement)(button);
                      _context5.next = 4;
                      return (0, _post.getPostData)(postId);

                    case 4:
                      postData = _context5.sent;
                      // originalPostContainer
                      (0, _post.outputPosts)([postData.data], $("#originalPostContainer"));
          ...
          $("#replyModal").on("hidden.bs.modal", /*#__PURE__*/function () {
                ...
                while (1) {
                  switch (_context7.prev = _context7.next) {
                    case 0:
                      ...
                      return _context7.abrupt("return", alert("button id is null"));
          ...
          $(document).on("click", ".post", function (evt) {
            ...
            var postId = (0, _post.getPostIdFromElement)(element);

            if (postId !== undefined && !element.is("button") && !element.is("i")) {
              window.location.href = "posts/".concat(postId);
            }
          });
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "14303" + '/');
